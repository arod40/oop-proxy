...
public class ProxyClass implements InvocationHandler {
	...
	public Object invoke(Object proxy, Method m, Object[] args) throws Throwable {
		...
		try {
			if (args != null)
				for(Object arg: args){
					if (arg instanceof String && ((String) arg).startsWith("secret"))
		...
		} catch (InvocationTargetException | ForbiddenException e) {
			throw e;
		} catch (Exception e) {
			...
			// if timer is not set, it gives NullPointerException
			timer = System.currentTimeMillis();
